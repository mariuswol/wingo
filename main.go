...
import (
	...
	"github.com/mariuswol/wingo/commands"
	"github.com/mariuswol/wingo/cursors"
	"github.com/mariuswol/wingo/event"
	"github.com/mariuswol/wingo/focus"
	"github.com/mariuswol/wingo/frame"
	"github.com/mariuswol/wingo/hook"
	"github.com/mariuswol/wingo/logger"
	"github.com/mariuswol/wingo/misc"
	"github.com/mariuswol/wingo/stack"
	"github.com/mariuswol/wingo/wm"
	"github.com/mariuswol/wingo/xclient"
)
...
func init() {
	...
	flag.StringVar(&flagConfigDir, "config-dir", flagConfigDir,
		"Override the location of the configuration files. When this\n"+
			...
			"$GOPATH/src/github.com/mariuswol/wingo/config")
	flag.StringVar(&flagDataDir, "data-dir", flagDataDir,
		"Override the location of the data files (images/fonts). When this\n"+
			...
			"$GOPATH/src/github.com/mariuswol/wingo/data")
